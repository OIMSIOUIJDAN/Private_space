    ...
    <div className="min-h-screen pb-28 px-5 pt-12">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-8 pt-6">
          ...
          >
            <Heart className="text-burgundy fill-burgundy/30" size={36} />
          </motion.div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 gap-3 mb-8">
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-5 shadow-sm border border-rose-light/30 text-center">
            <Calendar size={20} className="text-dusty-rose mx-auto mb-2" />
            <div className="font-serif text-3xl text-burgundy font-semibold mb-1">
              {daysSinceMet}
            </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-5 shadow-sm border border-rose-light/30 text-center">
            <Clock size={20} className="text-dusty-rose mx-auto mb-2" />
            <div className="font-serif text-3xl text-burgundy font-semibold mb-1">
              {daysUntilDate}
            </div>
            <div className="text-xs text-text-muted font-medium">
        ...
        <motion.div variants={itemVariants} className="space-y-3 mb-8">
          <button
            ...
            className="w-full bg-gradient-to-r from-soft-pink/80 to-blush/80 backdrop-blur-sm rounded-3xl p-5 shadow-sm border border-rose-light/20 flex items-center gap-4 text-left active:scale-[0.98] transition-transform"
          >
            <div className="w-12 h-12 rounded-2xl bg-white/80 flex items-center justify-center shadow-sm">
              <MessageCircle size={22} className="text-burgundy" />
            </div>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blush/80 to-cream backdrop-blur-sm rounded-3xl p-5 shadow-sm border border-rose-light/20 flex items-center gap-4 text-left active:scale-[0.98] transition-transform"
          >
            <div className="w-12 h-12 rounded-2xl bg-white/80 flex items-center justify-center shadow-sm">
              <Image size={22} className="text-burgundy" />
            </div>
            <div className="flex-1">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-cream to-soft-pink/60 backdrop-blur-sm rounded-3xl p-5 shadow-sm border border-rose-light/20 flex items-center gap-4 text-left active:scale-[0.98] transition-transform"
          >
            <div className="w-12 h-12 rounded-2xl bg-white/80 flex items-center justify-center shadow-sm">
        ...
        <motion.div variants={itemVariants} className="text-center mt-6">
          <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-6 border border-rose-light/20">
